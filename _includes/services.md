...
<li>
  <autocolor>MEDIEVAL AND EARLY-MODERN LEGAL HISTORY (ITALIAN)</autocolor> —
  ...
  <a href="assets/files/maps.zip"><autocolor>maps</autocolor></a> ·
  <a href="assets/files/reading-list.zip"><autocolor>reading list</autocolor></a> ·
</li>
</ul>
